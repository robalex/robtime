...
builder.Services.AddScoped<PunchChangeRequestService>();
builder.Services.AddScoped<PunchImportService>();
builder.Services.AddScoped<TimecardService>();
builder.Services.AddScoped<TimecardLockService>();
builder.Services.AddScoped<EmployeeScopeResolver>();
...
builder.Services.AddScoped<DifferentialSandboxService>();
...
app.MapDifferentialSandboxEndpoints();
