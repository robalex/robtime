...
import { useDeletePayRule, usePayRule, usePayRuleTemplates, useUpdatePayRule } from '@/features/payRules/queries'
      ...
      <div className="space-y-6">
        ...
        <div className="max-w-2xl rounded-lg border p-4">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Creating a new version from this one isn't available yet.
          </p>
        </div>
