...
public class RetroactiveBonusRecalculatorTests
{
    ...
    public void MultiWeekBonus_ApportionedByHours_AndAddsOvertimePremium()
    {
        ...
        var result = RetroactiveBonusRecalculator.Recalculate(400m, weeks, new FederalOvertimeRule(), _ => 20m);
    ...
    public void BonusInWeekWithoutOvertime_AddsNoPremium()
    {
        ...
        var result = RetroactiveBonusRecalculator.Recalculate(300m, weeks, new FederalOvertimeRule(), _ => 20m);
