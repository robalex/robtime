...
namespace TimeCalculation.Persistence.Migrations
{
    ...
    [Migration("20260803202241_AddPayrollExportBatch")]
    partial class AddPayrollExportBatch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeCalculation.Persistence.PayrollExportBatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_payroll_export_batches");

                    b.HasIndex("ClientId", "ProfileId", "ExportedAt")
                        .HasDatabaseName("ix_payroll_export_batches_client_id_profile_id_exported_at");

                    b.HasIndex("ProfileId", "PeriodStart", "PeriodEnd")
                        .IsUnique()
                        .HasDatabaseName("ix_payroll_export_batches_profile_id_period_start_period_end")
                        .HasFilter("voided_at IS NULL");

                    b.ToTable("payroll_export_batches", (string)null);
                });
            ...
            modelBuilder.Entity("TimeCalculation.Persistence.PayrollExportBatch", b =>
                {
                    b.HasOne("TimeCalculation.Model.Client", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_payroll_export_batches_clients_client_id");
                    ...
                    b.HasOne("TimeCalculation.Persistence.PayrollExportProfile", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_payroll_export_batches_payroll_export_profiles_profile_id");
                });
